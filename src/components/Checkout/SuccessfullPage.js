            ...
            <div className='aem-Grid aem-Grid--12' aria-label="Add Cart Details">
              <div className="aem-GridColumn aem-GridColumn--default--6 aem-GridColumn--phone--12">
                <div className="shipping--information--edit">
                  ...
                  <div className='shipping--information--edit__address'>{getFormShIn.StreetAddress} <br /> {getFormShIn.StreetAddress2}</div>
              ...
              <div className="aem-GridColumn aem-GridColumn--default--6 aem-GridColumn--phone--12">
                ...
                <div className="shipping--information--edit payment--method--edit">
                  ...
                  <div className="aem-GridColumn aem-GridColumn--default--6 aem-GridColumn--phone--12">
                    <div className='shipping--Method--edit__standarshipping'>{getFormPayIn.BillingPayment}</div>
                    <div className='shipping--Method--edit__standarshipping'>{getFormPayIn.BillingPayment == 'Credit Card' ? 'Visa ending in ' + getFormPayIn.CreditCardNumber.slice(-4) : ''}</div>
                  </div>
                </div>
              </div>
            </div>
